...
### 02 — API testing
Учебная практика REST API в Postman: GET/POST/PUT/DELETE, параметры, JSON, HTTP status codes, позитивные и негативные проверки.

[Перейти к проекту](02-api-testing/README.md)

### 03 — SQL
Учебная практика SQL до уровня JOIN: SELECT, фильтрация, сортировка, группировка и работа со связанными таблицами.
