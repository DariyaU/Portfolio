...
## Какие проверки я могу объяснить на собеседовании

- выбор HTTP-метода под операцию;
- различие между path parameters и query parameters;
- проверка request body и JSON-структуры;
- проверка HTTP status code;
- проверка response body и обязательных полей;
- позитивные и негативные сценарии;
- CRUD: Create / Read / Update / Delete;
- использование переменных в Postman;
- базовые Postman scripts и проверки ответа;
- проверка headers;
- базовая проверка авторизации по готовым учебным запросам.

**Важно:** наличие сценария в этом файле не означает, что результат его выполнения был подтверждён в исходной коллекции. Для портфолио зафиксирована именно учебная практика и структура проверок, без вымышленных фактических результатов.
